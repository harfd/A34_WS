...
using TrajectoryPoint = FSD::TrajectoryPoint;
using Trajectory = FSD::Trajectory;
...
class BoundaryDetector {
 ...
 public:
  ...
  visualization_msgs::MarkerArray getVisualTraj();
  geometry_msgs::PoseArray getPlanningTraj();
...
private:
  ...
  geometry_msgs::PoseArray planningTraj;
  ...
  void getTraj(std::vector<PathPoint> &BestPath);
  void calPlanningTraj(std::vector<PathPoint> &BestPath);
};
}
